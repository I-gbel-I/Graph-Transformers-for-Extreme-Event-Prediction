...
from utils.metrics import SquaredErrorRelevanceArea, WeightedFocalMSE
...
class GraphTransformerNet(nn.Module):
    ...
    def __init__(self, net_params):
        ...
        self.criterion_wfmse = WeightedFocalMSE()
    ...
    def loss(self, scores, targets, rels, criterion):
        ...
        if criterion == 0:
            ...
            # res2 = nn.functional.mse_loss(scores, targets)
            #
            # #
            # #
            # print('mse:', res2)
            ...
            res = self.criterion_wfmse.loss(scores, targets, rels)
